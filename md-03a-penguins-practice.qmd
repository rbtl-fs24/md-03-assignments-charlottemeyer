...
5.  What data types are contained in the variables? (Reminder: [https://rbtl-fs24.github.io/website/slides/lec-02-visualisation.html#/types-of-variables](https://ds4owd-001.github.io/website/slides/lec-02-visualisation.html#/types-of-variables){.uri}) –\> factor, double and integer
...
```{r}
penguins |> 
  filter(sex == "female", species == "Chinstrap", island %in% c("Torgersen", "Dream"))
```
